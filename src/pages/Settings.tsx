      ...
      <div className="bg-card border border-border rounded-xl p-4 mb-3">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display text-sm uppercase text-muted-foreground flex items-center gap-2">
            <Palette className="w-4 h-4" /> {t("settings.branding")}
          </h3>
          {isAdmin && club && !editingBranding && (
        ...
        {!club ? (
          ...
          <div className="space-y-3">
            <div>
              <Label className="text-xs">{t("settings.brandingClubName")}</Label>
              <Input
            ...
            <div>
              <Label className="text-xs">{t("settings.brandingTagline")}</Label>
              <Input
            ...
            <div>
              <Label className="text-xs mb-1.5 block">{t("settings.brandingTheme")}</Label>
            ...
            <div className="flex gap-2 justify-end pt-1">
              ...
              <Button size="sm" onClick={saveBranding} disabled={savingBranding || !brandingForm.name.trim()} className="gap-1.5">
                {savingBranding ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Check className="w-3.5 h-3.5" />} {t("game.save")}
              </Button>
            </div>
          </div>
        ) : (

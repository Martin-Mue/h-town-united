...
import { Trophy, Plus, Play, RotateCcw, Trash2, Users, Check, Sparkles, Layers, Radio, Copy, Zap, Maximize2, ZoomIn, ZoomOut, ChevronDown, ChevronUp, Shuffle, ArrowUp, ArrowDown, ArrowLeft, Settings2, PencilLine, ListOrdered, Network, UserMinus, UserPlus, Monitor, QrCode, RefreshCcw, Target, Smartphone, Swords, Wifi, Timer } from "lucide-react";
...
// Round 4 Rang 5: nextPowerOfTwo/lowerPowerOfTwo/chooseAutoMainSize/defaultBracketView/shuffle/
// mulberry32/seededShuffle/bracketSeedOrder/fairSeededOrder/distributeByes/buildSeeding (and the
// Seeding type) used to be defined right here -- moved verbatim to utils/bracketSeeding.ts (see
// the import near the top of this file), since this was the single largest file in the app and
// every one of these is a pure, closure-free function with no React state or JSX. Same scoping
// decision as Round 3 Rang 12's legLogic.ts extraction from Game.tsx: no behavior change, not a
// full refactor, just makes these directly unit-testable.
